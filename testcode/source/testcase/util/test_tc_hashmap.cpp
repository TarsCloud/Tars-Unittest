...
{    
    ...
    */
    ...
    else if(option.hasParam("set-taf"))
    {
        ...
        {
            cout << "set-taf erase:" << vRecords[i]._key << ":" << vRecords[i]._value << endl;
        }
    }
    ...
    else if(option.hasParam("erase"))
    {
        ...
        do
        {
            ...
            cout << "erase: " << data._key << "|" << data._value << endl;
...
TEST(TarsUtilTestcase, UT_TC_HashMap)
{
/* 
